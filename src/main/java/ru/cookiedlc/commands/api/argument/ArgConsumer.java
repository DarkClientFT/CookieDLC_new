...
package ru.cookiedlc.commands.api.argument;
...
import ru.cookiedlc.commands.api.command.datatypes.IDatatype;
import ru.cookiedlc.commands.api.command.datatypes.IDatatypeContext;
import ru.cookiedlc.commands.api.command.datatypes.IDatatypeFor;
import ru.cookiedlc.commands.api.command.datatypes.IDatatypePost;
...
import ru.cookiedlc.commands.api.command.exception.CommandTooManyArgumentsException;
