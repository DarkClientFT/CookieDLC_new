package ru.cookiedlc.commands.commands.render;
...
import ru.cookiedlc.commands.api.command.datatypes.BlockDataType;
import ru.cookiedlc.commands.api.command.datatypes.BlockESPDataType;
import ru.cookiedlc.commands.api.command.datatypes.EntityDataType;
import ru.cookiedlc.commands.api.command.datatypes.EntityESPDataType;
import ru.cookiedlc.commands.api.command.exception.CommandException;
import ru.cookiedlc.commands.api.command.helpers.Paginator;
...
public class BoxESPCommand extends Command implements QuickImports {
    ...
    public BoxESPCommand(Main main) {
        super("box");
