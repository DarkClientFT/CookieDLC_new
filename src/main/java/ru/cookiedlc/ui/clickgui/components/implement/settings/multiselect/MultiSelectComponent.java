package ru.cookiedlc.ui.clickgui.components.implement.settings.multiselect;
...
import ru.cookiedlc.ui.clickgui.components.implement.settings.AbstractSettingComponent;

import java.util.ArrayList;
import java.util.List;

import static ru.cookiedlc.api.system.font.Fonts.Type.BOLD;
import static ru.cookiedlc.api.system.font.Fonts.Type.ICO;
...
public class MultiSelectComponent extends AbstractSettingComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        float availableSpaceBelow = window.getScaledHeight() - (y + 20);
        float availableSpaceAbove = y - 4;
        boolean openUpwards = availableSpaceBelow < dropDownListHeight && availableSpaceAbove > availableSpaceBelow;
        
        if (openUpwards) {
            this.dropDownListY = y + 4 - dropDownListHeight;
        } else {
