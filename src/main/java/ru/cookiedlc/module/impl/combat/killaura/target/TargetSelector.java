package ru.cookiedlc.module.impl.combat.killaura.target;
...
import ru.cookiedlc.module.impl.combat.killaura.rotation.PointFinder;
...
public class TargetSelector implements QuickImports {
    ...
    private double getFov(LivingEntity entity, float maxDistance, boolean ignoreWalls) {
        Vec3d attackVector = pointFinder.computeVector(entity, maxDistance, RotationController.INSTANCE.getRotation(), new LinearMode().randomValue(), ignoreWalls).getLeft();
