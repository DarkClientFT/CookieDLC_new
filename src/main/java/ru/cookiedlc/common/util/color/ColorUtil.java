package ru.cookiedlc.common.util.color;
...
public class ColorUtil {
    ...
    public int getInterfaceColor() {
        return getGuiRectColor(0.7f);
    }

    public int getInterfaceColor(float alpha) {
        return getGuiRectColor(alpha);
    }
    public int getInterfaceColorLight() {
        return getGuiRectColor2(0.65f);
    }
    public int getInterfaceColorDark() {
        return multAlpha(new Color(0x121218).getRGB(), 0.75f);
    }

    public int getClientAccentColor() {
        return getClientColor();
    }
    public int getClientAccentColor(float alpha) {
        return getClientColor(alpha);
    }
    public int[] getClientToDarkGradient(int length) {
        return genGradientForText(getClientColor(), getInterfaceColorDark(), length);
    }
    public int[] getLightToDarkGradient(int length) {
        return genGradientForText(getText(), getMainGuiColor(), length);
    }
